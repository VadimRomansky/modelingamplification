...
for i = 1: N3,
    ...
    funLocal(i,2) = field(i,1)*field(a1*N3 + i,2);
    funLocal(i,3) = field(i,1)*field(a2*N3 + i,2);
    funLocal(i,4) = field(i,1)*field(a3*N3 + i,2);
    
    fun(i,1) = field(i,1);
    fun(i,2) = field(i,1)*field(a1*N3 + i,4);
    fun(i,3) = field(i,1)*field(a2*N3 + i,4);
    fun(i,4) = field(i,1)*field(a3*N3 + i,4);
