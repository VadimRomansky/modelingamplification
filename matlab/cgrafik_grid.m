...
grid ;
figure(2);
plot (r(1:N2,1),rho(1:N2,2),'cyan',r(1:N2,1),rho(1:N2,3),'green',r(1:N2,3),rho(1:N2,4),'blue',r(1:N2,4),rho(1:N2,5),'black',r(1:N2,5),rho(1:N2,6),'yellow',r(1:N2,6),rho(1:N2,7),'red');
title ('density');
xlabel ('r cm');
ylabel ('rho 10^-5 g/cm^3');
grid ;
figure(3);
plot (r(1:N2,1),pressure(1:N2,2),'cyan',r(1:N2,1),pressure(1:N2,3),'green',r(1:N2,3),pressure(1:N2,4),'blue',r(1:N2,4),pressure(1:N2,5),'black',r(1:N2,5),pressure(1:N2,6),'yellow',r(1:N2,6),pressure(1:N2,7),'red');
title ('pressure');
xlabel ('r cm');
ylabel ('P din/cm^2');
grid ;
figure(4);
plot (r(1:N2,1),temp(1:N2,2),'cyan',r(1:N2,1),temp(1:N2,3),'green',r(1:N2,3),temp(1:N2,4),'blue',r(1:N2,4),temp(1:N2,5),'black',r(1:N2,5),temp(1:N2,6),'yellow',r(1:N2,6),temp(1:N2,7),'red');
title ('tempertature');
xlabel ('r cm');
ylabel ('T');
grid;
figure(5);
plot (r(1:N2,1),flux(1:N2,2),'cyan',r(1:N2,1),flux(1:N2,3),'green',r(1:N2,3),flux(1:N2,4),'blue',r(1:N2,4),flux(1:N2,5),'black',r(1:N2,5),flux(1:N2,6),'yellow',r(1:N2,6),flux(1:N2,7),'red');
title ('mass flux');
xlabel ('r cm');
ylabel ('g*cm/s');
grid;