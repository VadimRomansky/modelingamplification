...
grid ;
figure(5);
plot (crflux(1:N2,1),crflux(1:N2,2),'red',crflux(1:N2,1),crflux(1:N2,3),'green',crflux(1:N2,1),crflux(1:N2,4),'blue',crflux(1:N2,1),crflux(1:N2,5),'black',crflux(1:N2,1),crflux(1:N2,6),'yellow',crflux(1:N2,1),crflux(1:N2,7),'cyan');
