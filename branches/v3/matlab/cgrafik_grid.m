...
for j=1:N2,
    ...
    massvel(j,2)=tamc_radial_profile(j,4);
    massvel(j,3)=tamc_radial_profile(a*N2 + j,4);
    massvel(j,4)=tamc_radial_profile(b*N2 + j,4);
    massvel(j,5)=tamc_radial_profile(c*N2 + j,4);
    massvel(j,6)=tamc_radial_profile(d*N2 + j,4);
    massvel(j,7)=tamc_radial_profile(e*N2 + j,4);       
    rho(j,1)=tamc_radial_profile(j,1);
    rho(j,2)=tamc_radial_profile(j,5);
    rho(j,3)=tamc_radial_profile(a*N2 + j,5);
    rho(j,4)=tamc_radial_profile(b*N2 + j,5);
    rho(j,5)=tamc_radial_profile(c*N2 + j,5);
    rho(j,6)=tamc_radial_profile(d*N2 + j,5);
    rho(j,7)=tamc_radial_profile(e*N2 + j,5);
    ...
    temp(j,6)=tamc_radial_profile(e*N2 + j,6);
    temp(j,7)=tamc_radial_profile(d*N2 + j,6); 
end;
figure(1);
...
grid ;
figure(3);
plot (massvel(1:N2,1),massvel(1:N2,2),'red',massvel(1:N2,1),massvel(1:N2,3),'green',massvel(1:N2,1),massvel(1:N2,4),'blue',massvel(1:N2,1),massvel(1:N2,5),'black',massvel(1:N2,1),massvel(1:N2,6),'yellow',massvel(1:N2,1),massvel(1:N2,7),'cyan');
title ('mass U');
xlabel ('r');
ylabel ('U');
grid ;
