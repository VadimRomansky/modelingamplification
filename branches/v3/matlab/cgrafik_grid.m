...
for j=1:N2,
    ...
    crpressure(j,1)=tamc_radial_profile(j,1);
    crpressure(j,2)=tamc_radial_profile(j,10);
    crpressure(j,3)=tamc_radial_profile(a*N2 + j,10);
    crpressure(j,4)=tamc_radial_profile(b*N2 + j,10);
    crpressure(j,5)=tamc_radial_profile(c*N2 + j,10);
    crpressure(j,6)=tamc_radial_profile(d*N2 + j,10);
    crpressure(j,7)=tamc_radial_profile(e*N2 + j,10);
end;
figure(1);
