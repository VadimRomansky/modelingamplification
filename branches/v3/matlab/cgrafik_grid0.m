...
grid ;
figure(4);
plot (temp(N4:N2,1),temp(N4:N2,2),'cyan',temp(N4:N2,1),temp(N4:N2,3),'green',temp(N4:N2,1),temp(N4:N2,4),'blue',temp(N4:N2,1),temp(N4:N2,5),'black',temp(N4:N2,1),temp(N4:N2,6),'yellow',temp(N4:N2,1),temp(N4:N2,7),'red');
title ('tempertature');
xlabel ('r cm');
ylabel ('T');
grid;
figure(5);
plot (flux(N4:N2,1),flux(N4:N2,2),'cyan',flux(N4:N2,1),flux(N4:N2,3),'green',flux(N4:N2,1),flux(N4:N2,4),'blue',flux(N4:N2,1),flux(N4:N2,5),'black',flux(N4:N2,1),flux(N4:N2,6),'yellow',flux(N4:N2,1),flux(N4:N2,7),'red');
title ('mass flux');
xlabel ('r cm');
ylabel ('g*cm/s');
grid;