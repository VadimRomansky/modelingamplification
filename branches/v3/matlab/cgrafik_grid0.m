...
figure(1);
plot (vel(N4:N2,1),vel(N4:N2,3),'green',vel(N4:N2,1),vel(N4:N2,4),'blue',vel(N4:N2,1),vel(N4:N2,5),'black',vel(N4:N2,1),vel(N4:N2,6),'yellow',vel(N4:N2,1),vel(N4:N2,7),'red');
title ('u(x)');
xlabel ('r cm');
ylabel ('U cm/s');
grid ;
figure(2);
plot (rho(N4:N2,1),rho(N4:N2,3),'green',rho(N4:N2,1),rho(N4:N2,4),'blue',rho(N4:N2,1),rho(N4:N2,5),'black',rho(N4:N2,1),rho(N4:N2,6),'yellow',rho(N4:N2,1),rho(N4:N2,7),'red');
title ('density');
xlabel ('r cm');
ylabel ('rho 10^-5 g/cm^3');
grid ;
figure(3);
plot (pressure(N4:N2,1),pressure(N4:N2,3),'green',pressure(N4:N2,1),pressure(N4:N2,4),'blue',pressure(N4:N2,1),pressure(N4:N2,5),'black',pressure(N4:N2,1),pressure(N4:N2,6),'yellow',pressure(N4:N2,1),pressure(N4:N2,7),'red');
title ('pressure');
xlabel ('r cm');
ylabel ('P din/cm^2');
grid ;
figure(4);
plot (temp(N4:N2,1),temp(N4:N2,3),'green',temp(N4:N2,1),temp(N4:N2,4),'blue',temp(N4:N2,1),temp(N4:N2,5),'black',temp(N4:N2,1),temp(N4:N2,6),'yellow',temp(N4:N2,1),temp(N4:N2,7),'red');
title ('tempertature');
xlabel ('r cm');
ylabel ('T');
grid;
figure(5);
plot (flux(N4:N2,1),flux(N4:N2,3),'green',flux(N4:N2,1),flux(N4:N2,4),'blue',flux(N4:N2,1),flux(N4:N2,5),'black',flux(N4:N2,1),flux(N4:N2,6),'yellow',flux(N4:N2,1),flux(N4:N2,7),'red');
title ('mass flux');
xlabel ('r cm');
ylabel ('g*cm/s');
grid;